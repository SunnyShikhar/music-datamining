...
client_credentials_manager = SpotifyClientCredentials('89346a77c6754616aced6f3900431241', '18a4003cbfdf48ebbd01a83b001843c1')
sp = spotipy.Spotify(client_credentials_manager=client_credentials_manager)
sp.trace=False

#read and output the inputted excel sheet
songs_array = pd.read_csv('data/songs_only.csv')
print(songs_array)
...
result.to_csv('data/song_metrics.csv')
