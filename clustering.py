...
dataset = dataset.drop(columns=['gender', 'timestamp','age','amount_music','life_enjoyment','resilience','balanced_life',
                                'emotional_flex','self_actualization','health_categorical','trauma','song1', 'song2', 'song3'])
